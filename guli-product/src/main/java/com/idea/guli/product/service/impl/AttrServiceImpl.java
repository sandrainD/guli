...
import com.idea.guli.product.dao.AttrAttrgroupRelationDao;
...
import com.idea.guli.product.dao.AttrDao;
import com.idea.guli.product.entity.AttrEntity;
import com.idea.guli.product.service.AttrService;
...
//        attrEntity.setAttrName(attr.getAttrName());
    ...
    @Cacheable(value = "attr",key = "'sttrinfo:'+#root.args[0]")
    @Override
    ...
    public List<Long> selectSearchAttrIds(List<Long> attrIds) {
        return baseMapper.selselectSearchAttrIds(attrIds);
    }
